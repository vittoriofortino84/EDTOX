...
|1|[1_1_MIEs_from_CTD.R](https://github.com/amir1715/EDTOX/blob/master/scripts/1_1_MIEs_from_CTD.R)|
| ------------- |--------------|
...
|2| [1_2_Pathways_Download.R](https://github.com/amir1715/EDTOX/blob/master/scripts/1_2_Pathways_Download.R)
| ------------- |--------------|
...
|3| [1_3_TOXCAST_nuclear_receptors_coregulators.R](https://github.com/amir1715/EDTOX/blob/master/scripts/1_3_TOXCAST_nuclear_receptors_coregulators.R)|
| ------------- |--------------|
...
- **Summary**:
- [x] Preparation of a dictionary for ToxCast target genes and their corresponding endpoints.
- [x] Conversion of ToxCast DSSTox_Identifiers to CAS registry identifiers and preparation of the final Hitcall matrix for all  ToxCast endpoints.
