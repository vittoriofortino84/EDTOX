...
# input
load('output/glm_models/two_class_glm_models_metabolic_syndrome.RData')                       # glm model for disease
model_name<-metabolic_syndrome_two_class                                                             # name of models
path_to_CV_results_for_disease<-'output/glm_models/CV_two_class/metabolic_syndrome/'          # path to CV results

# output
RData_file<-'output/metabolic_syndrome_coefficients_stabilities_two_class.RData'              # OUTPUT save file name RData
...
rm(list=ls())
# input 
load('output/glm_models/two_class_glm_models_metabolic_syndrome.RData')                        #GLM coefficients and stabilities
model_name<-metabolic_syndrome_two_class  
load('output/train_set_metabolic_syndrome_binary.RData')                                       #TRAINING SET (nes SCORES)
fgs<-train_set_metabolic_syndrome
disease_positive_label<-"edc_positive_metabolic_syndrome"                                      # disease positive label 
disease_negative_label<-"edc_negative_metabolic_syndrome"                                      # disease negative label
glm_stability_file_path<-'output/metabolic_syndrome_coefficients_stabilities_two_class.RData'  # output of previuos step

# output
RData_file<-'output/metabolic_syndrome_coefficients_stabilities_two_class_NES.RData'                    # OUTPUT
...
fgs<-train_set_metabolic_syndrome
disease_positive_label<-"edc_positive_metabolic_syndrome"                                      # disease positive label 
disease_negative_label<-"edc_negative_metabolic_syndrome" 
path_to_final_data<-'output/metabolic_syndrome_coefficients_stabilities_two_class_NES.RData' # path to final data of glm coefs, stabilites and NES scores

# output
final_Rdata<-'output/metabolic_syndrome_coefficients_stabilities_two_class_NES_ROC.RData'                  # RDATA file
final_excel<-'output/excel_files/final_data_metabolic_syndrome.csv'                                        # Excel file
...
rm(list=ls())
#input
all_data_final<-read.csv('output/excel_files/final_data_metabolic_syndrome.csv',stringsAsFactors = F)
# output
output_file<-'output/excel_files/for_janni_metabolic_syndrome.xlsx'
